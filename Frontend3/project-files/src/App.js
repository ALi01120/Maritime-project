...
import WhatsAppChat from './components/supportPage';
import CustomChatButton from './components/Studenpages/messagePage';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/support" element={<WhatsAppChat />} />
        ...
        <Route path="/Student/chat" element={<ProtectedRoute element={<CustomChatButton/>} role="Student" />} />
