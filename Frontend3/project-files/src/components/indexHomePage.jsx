        ...
        <div>
            ...
            <header className='header1'>
                <div className="text-overlay1">
                    <h1 style={{color:'white'}}>Welcome to Maritime </h1>
                    <p>Providing quality education for a better future</p>
                    <Link to="/register" className="join-now-button">Join Now </Link>
                </div>
                <img src={img} alt='education' loading="lazy" />
            </header>
            <section className="news-section">
                <h2>Eduction</h2>
                <div className="news-images">
                    <div className="image-container">
                        <img src={img1} alt='education1' loading="lazy" />
                        <p>Maritime Engineering</p>
                    </div>
                    <div className="image-container">
                        <img src={img2} alt='education2' loading="lazy" />
            ...
            <section className="education-section1">
                ...
                <div className="education-images">
                    <div className="image-container">
                        <img src={img3} alt='news1' loading="lazy" />
                        <p>Shipping and Offshore</p>
                    </div>
                    <div className="image-container">
                        <img src={img4} alt='news2' loading="lazy" />
                        <p>Port and Logistics</p>
                    </div>
                    <div className="image-container">
                        <img src={img5} alt='news3' loading="lazy" />
                        <p>Marine Science</p>
                    </div>
                    <div className="image-container">
                        <img src={img6} alt='news4' loading="lazy" />
                        <p>Persian Gulf</p>
                    </div>
                </div>
            </section>
            ...
            <section className="future-section">
                ...
                <div className="future-images">
                    <div className="image-container">
                        <Link to="/register">
                            <img src={img7} alt='future1' loading="lazy" />
                            <p>Maritime LMS</p>
                        </Link>
                    </div>
                    <div className="image-container">
                        <Link to="/register">
                            <img src={img8} alt='future2' loading="lazy" />
                            <p>Find a job</p>
                        </Link>
                    </div>
                    <div className="image-container">
                        <Link to="/register">
                            <img src={img9} alt='future3' loading="lazy" />
                            <p>Hire Client</p>
                        </Link>
                    </div>
                </div>
